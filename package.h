...
package_t * package_init( int nfunctions, char name[] );




func_info_t * package_new_func( char name[], 
                          int nparams, 
                          int nreturns, 
                          int * type_params, 
                          int * type_returns, 
...
int package_is_defined( char name[] );

func_info_t * package_func_get( char name[], int nparams );

func_info_t * package_func_get_any( char name[] );
